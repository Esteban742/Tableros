...
const AddToCard = () => {
	...
	return (
		<Container>
			<Title>Agregar a la tarjeta</Title>
			...
			<Button title='Portada' clickCallback={(event) => setCoverPopover(event.currentTarget)} icon={<CoverIcon fontSize='small' />}></Button>
			{coverPopover && (
				<BasePopover
